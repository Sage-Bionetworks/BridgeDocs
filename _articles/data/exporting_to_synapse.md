...
|substudyMemberships|**NOTE: Studies were previously known as substudies, and for backwards compatability, this field name is maintained in the exported research data.** A mapping from study ID to the participant's external ID. If the participant is not in that study, there will be no entry for that particular study. A user might be in a study without an external ID. The data is in the format "&#124;[substudyId1]=[externalId1]&#124;[substudyId2]=[externalId2]&#124;".|
