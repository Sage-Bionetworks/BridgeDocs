...
| first\_sign\_in | This event records the first time the participant signs in to the Bridge server through any authentication mechanism (except for reauthentication, since this logically follows an initial sign in). |  Immutable |
